...
export const api_username = "user";
export const patients_api_pwd = "patients";
export const prescriptions_api_pwd = "prescriptions";
export const appointments_api_pwd = "appointments";
            ...
            <div className="container">
                ...
                <div className="main-content">
                    <Routes>
                        ...
                        <Route path="/requests" element={<ProtectedRoute isLoggedIn={isLoggedIn}><Requests authToken={authToken} /></ProtectedRoute>} />
                    </Routes>
                </div>
            </div>
        </Router>
...
// docker save -o patient-service.tar patient-service
// scp -i "docker-jul4.pem" patient-service.tar ec2-user@your-ec2-public-dns:/home/ec2-user/

// ssh -i "docker-jul4.pem" ec2-user@your-ec2-public-dns
// docker load -i patient-service.tar
// docker run -d -p 8080:8080 --name patient-service patient-service